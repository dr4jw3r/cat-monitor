...
def createparser():
    ...
    parser.add_argument('--number-images', action='store', default=2, type=int, help='number of images to capture on motion detection')
    parser.add_argument('--image-interval', action='store', default=60, type=int, help='seconds between two detections at which to capture images')
    parser.add_argument('--image-sleep', action='store', default=3, type=int, help='seconds between two captures within one motion detection')
